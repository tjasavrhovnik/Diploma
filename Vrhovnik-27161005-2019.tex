...
Mertensova funkcija raste počasi, saj se njena vrednost v vsakem naslednjem naravnem številu spremeni kvečjemu za $\pm 1$. Ne obstaja naravno število $n$, za katerega bi veljalo $|M(n)| > n$.

Naslednjo trditev, ki jo bomo navedli brez dokaza, je leta 1912 dokazal Litllewood\footnote{John Edensor Littlewood, 9.\ 6.\ 1885 -- 6.\ 9.\ 1977, angleški matematik.}. Njeno bistvo je, da Riemannovo hipotezo lahko prevedemo na ekvivalentno trditev, ki opisuje rast Mertensove funkcije. Več o njej si bralec lahko prebere v \cite[poglavje 12.1]{zetafunction}.
