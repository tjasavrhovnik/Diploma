...
\begin{trditev}
Pravokotna trikotnika, ki pripadata poljubnima paroma Fordovih sosedov, določata različni pitagorejski trojici.
\end{trditev}
...
\begin{eqnarray}
\frac{1}{2b^2}-\frac{1}{2d^2} &=& \lambda (\frac{1}{2b'^2}-\frac{1}{2d'^2}) \\
\frac{1}{2b^2}+\frac{1}{2d^2} &=& \lambda (\frac{1}{2b'^2}+\frac{1}{2d'^2}) \\
\frac{c}{d}-\frac{a}{b} &=& \lambda(\frac{c'}{d'}-\frac{a'}{b'})
\end{eqnarray}
...
\begin{equation}
\frac{1}{bd} = \frac{bc-ad}{bd} = \frac{c}{d}-\frac{a}{b} = \lambda (\frac{c'}{d'}-\frac{a'}{b'}) = \lambda \frac{b'c'-a'd'}{b'd'} = \lambda \frac{1}{b'd'}
\end{equation}
...
Nazadnje še v pogoj za tangentnost Fordovih krogov C($\frac{a'}{b'}$) in C($\frac{c'}{d'}$) vstavimo (4) in (6):
\begin{gather}
b'c'-a'd' = 1 \nonumber \\
