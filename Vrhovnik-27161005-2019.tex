...
\right],
\]
kjer so $a,b,c,d \in \mathbb{C}$. Ker velja $ad-bc=1$, je matrika $A \in {SL}_{2}(\mathbb{C})$. Zato bomo M\"{o}biusove transformacije predstavljali s splošno linearno grupo ${SL}_{2}(\mathbb{C})$.
